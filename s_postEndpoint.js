...
const handlerWrapperArgs = { functionName: 'curso-slsl-hola-mundo-dev-postEndpoint', timeout: 6 };

try {
  const userHandler = require('./handler.js');
  module.exports.handler = serverlessSDK.handler(userHandler.postEndpoint, handlerWrapperArgs);
} catch (error) {
